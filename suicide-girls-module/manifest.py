...
class Manifest:
	...
	def get_parser(cls, provided_parser):
		...
		provided_parser.add_argument("-i", "--in", dest="time_period", choices=cls.time_periods, default=cls.time_periods[0], help="The time period to filter the 'all_' types to")
